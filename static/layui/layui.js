    ...
    var t, h = d.document, m = {
        ...
        o.prototype.link = function(n, o, t) {
            var r = this
                ...
                , t = ((t = "string" == typeof o ? o : t) || n).replace(/\.|\//g, "")
                , a = i.id = "layuicss-" + t
                , u = "creating"
                , l = 0;
...
!function(i, g) {
    ...
    var n = i.layui && layui.define
        ...
        , E = "layui-laydate-shade"
        , S = function(e) {
        var t, a = this, n = (a.index = ++v.index,
            a.config = lay.extend({}, a.config, v.config, e),
            lay(e.elem || a.config.elem));
        return 1 < n.length ? (lay.each(n, function() {
            v.render(lay.extend({}, a.config, {
                elem: this
            }))
        }),
    ...
    s.formatArr = function(e) {
        ...
        S.prototype.render = function() {
            var a, n, i, l, r = this, o = r.config, d = r.lang(), s = "static" === o.position, y = r.elem = lay.elem("div", {
                id: r.elemID,
                "class": ["layui-laydate", o.range ? " layui-laydate-range" : "", r.rangeLinked ? " layui-laydate-linkage" : "", s ? " " + D : "", o.fullPanel ? " laydate-theme-fullpanel" : "", (a = "",
                ...
                (o.range || "datetime" !== o.type || o.fullPanel) && f.push('<span class="' + T + '" title="' + d.preview + '"></span>'),
            ...
            o.showBottom && y.appendChild(e),
                lay.elem("style")), p = [], t = (lay.each(o.theme, function(e, t) {
                /^#/.test(t) && (l = !0,
                    p.push(["#{{id}} .layui-laydate-header{background-color:{{theme}};}", "#{{id}} li.layui-this,#{{id}} td.layui-this>div{background-color:{{theme}} !important;}", -1 !== o.theme.indexOf("circle") ? "" : "#{{id}} .layui-this{background-color:{{theme}} !important;}"].join("").replace(/{{id}}/g, r.elemID).replace(/{{theme}}/g, t)))
            }),
            ...
            l && lay(y).addClass("laydate-theme-molv"),
                y.appendChild(f)),
                r.remove(S.thisElemDate),
                v.thisId = o.id,
                s ? o.elem.append(y) : (g.body.appendChild(y),
                    r.position()),
                o.shade ? '<div class="' + E + '" style="z-index:' + (parseInt(layui.getStyle(y, "z-index")) - 1) + "; background-color: " + (o.shade[1] || "#000") + "; opacity: " + (o.shade[0] || o.shade) + '"></div>' : "");
            y.insertAdjacentHTML("beforebegin", t),
                r.checkDate().calendar(null, 0, "init"),
                r.changeEvent(),
                S.thisElemDate = r.elemID,
                r.renderAdditional(),
        ...
        S.prototype.checkDate = function(e) {
            ...
            return c(),
                "string" == typeof l && l ? d.EXP_IF.test(l) ? s.range ? (l = l.split(" " + d.rangeStr + " "),
                    ...
                    c(),
                    delete d.endTime),
            d.rangeElem && (c = [d.rangeElem[0].val(), d.rangeElem[1].val()],
            ...
            o && l && d.setValue(!s.range || d.endDate ? d.parse() : ""),
                d.getDateTime(n) > d.getDateTime(s.max) ? (n = s.dateTime = lay.extend({}, s.max),
                    u = !0) : d.getDateTime(n) < d.getDateTime(s.min) && (n = s.dateTime = lay.extend({}, s.min),
                    u = !0),
        ...
        S.prototype.calendar = function(e, t, a) {
            var i, l, r, o = this, n = o.config, t = t ? 1 : 0, d = e || o.thisDateTime(t), s = new Date, y = o.lang(), m = "date" !== n.type && "datetime" !== n.type, u = lay(o.table[t]).find("td"), c = lay(o.elemHeader[t][2]).find("span");
            ...
            o.firstDate || (o.firstDate = lay.extend({}, d)),
                ...
                lay(c[0]).attr("lay-ym", d.year + "-" + (d.month + 1)),
                lay(c[1]).attr("lay-ym", d.year + "-" + (d.month + 1)),
                "cn" === n.lang ? (lay(c[0]).attr("lay-type", "year").html(d.year + " \u5e74"),
                    lay(c[1]).attr("lay-type", "month").html(d.month + 1 + " \u6708")) : (lay(c[0]).attr("lay-type", "month").html(y.month[d.month]),
                    lay(c[1]).attr("lay-type", "year").html(d.year)),
            ...
            n.range || (u = ["hours", "minutes", "seconds"],
                o.limit({
        ...
        S.prototype.list = function(n, i) {
            var l, r, e, o, d = this, s = d.config, y = d.rangeLinked ? s.dateTime : [s.dateTime, d.endDate][i], m = d.lang(), t = s.range && "date" !== s.type && "datetime" !== s.type, u = lay.elem("ul", {
                "class": w + " " + {
                    year: "laydate-year-list",
                    month: "laydate-month-list",
                    time: "laydate-time-list"
                }[n]
            }), a = d.elemHeader[i], c = lay(a[2]).find("span"), h = d.elemCont[i || 0], f = lay(h).find("." + w)[0], p = "cn" === s.lang, g = p ? "\u5e74" : "", v = d.listYM[i] || {}, D = ["hours", "minutes", "seconds"], T = ["startTime", "endTime"][i];
            return v[0] < 1 && (v[0] = 1),
                "year" === n ? (e = l = v[0] - 7,
                l < 1 && (e = l = 1),
        ...
        ,
        S.prototype.listYM = [],
        S.prototype.closeList = function() {
            var a = this;
            a.config;
        ...
        S.prototype.preview = function() {
            ...
            a.isPreview && (e = lay(t.elem).find("." + T),
        ...
        l.run = function(n) {
            n(g).on("mousedown", function(e) {
                var t, a;
                !v.thisId || (t = s.getThis(v.thisId)) && (a = t.config,
                e.target !== a.elem[0] && e.target !== a.eventElem[0] && e.target !== n(a.closeStop)[0] && t.remove())
            }).on("keydown", function(e) {
                var t;
                !v.thisId || (t = s.getThis(v.thisId)) && "static" !== t.config.position && 13 === e.keyCode && n("#" + t.elemID)[0] && t.elemID === S.thisElemDate && (e.preventDefault(),
    ...
    var s = layui.$
        ...
        fixbar: function(i) {
            var o, e, t, n, a = "layui-fixbar", r = s(document), l = (i = s.extend(!0, {
                ...
                s(i.target)), c = i.scroll ? s(i.scroll) : s("body" === i.target ? r : l), u = (i["default"] && (i.bar1 && i.bars.push({
                type: "bar1",
            ...
            "object" == typeof i.css && u.css(i.css),
                l.append(u),
            o && (t = function t() {
                return c.scrollTop() >= i.margin ? e || (o.show(),
                    e = 1) : e && (o.hide(),
                    e = 0),
                    t
            }()),
        ...
        digit: function(e, t) {
            var n = "";
            t = t || 2;
            for (var i = (e = String(e)).length; i < t; i++)
                n += "0";
        ...
        toVisibleArea: function(e) {
            ...
            (e = s.extend({
                ...
                r = t.offset()[i],
                c = {},
            ((l = l.offset()[i] - r) > a - e.margin || l < e.margin) && (c[n] = l - a / 2 + o,
...
layui.define(["jquery", "laytpl", "lay"], function(e) {
    ...
    k.prototype.config = {
        ...
        y.spread = function(e) {
            ...
            e.hasClass(l) ? (e.removeClass(l).addClass(d),
                i.removeClass("layui-icon-down").addClass("layui-icon-up")) : (e.removeClass(d).addClass(l),
...
layui.define(["jquery", "lay"], function(e) {
    ...
    i.prototype.config = {
        ...
        i.prototype.render = function() {
            ...
            n.input && !n.range && (e = g('<div class="layui-slider-input layui-input"><div class="layui-slider-input-txt"><input type="text" class="layui-input"></div><div class="layui-slider-input-btn"><i class="layui-icon layui-icon-up"></i><i class="layui-icon layui-icon-down"></i></div></div>'),
...
layui.define("jquery", function(t) {
    ...
    var u = layui.$
        ...
        i.prototype.tabAdd = function(t, i) {
            var a, t = u(".layui-tab[lay-filter=" + t + "]"), e = t.children(s), l = e.children(".layui-tab-bar"), t = t.children(".layui-tab-content"), n = "<li" + (a = [],
        ...
        tabClick: function(t) {
            ...
            l || n || (a.addClass(c).siblings().removeClass(c),
                i.eq(t).addClass(y).siblings().removeClass(y)),
...
layui.define(["lay", "layer"], function(e) {
    ...
    var y = layui.$
        ...
        set: function(e) {
            var t = this;
            return t.config = y.extend({}, t.config, e),
                t
        },
        on: function(e, t) {
        ...
        , w = function(e) {
        var t = this;
        t.config = y.extend({}, t.config, i.config, e),
            t.render()
    };
    w.prototype.config = {
        accept: "images",
        ...
        w.prototype.file = function() {
            ...
            F.ie && F.ie < 10 && t.elem.wrap('<div class="layui-upload-wrap"></div>'),
                e.isFile() ? (e.elemFile = t.elem,
                    t.field = t.elem[0].name) : t.elem.after(i),
            F.ie && F.ie < 10 && e.initIE()
        }
        ,
        w.prototype.initIE = function() {
            var i, e = this.config, t = y('<iframe id="' + b + '" class="' + b + '" name="' + b + '" frameborder="0"></iframe>'), n = y(['<form target="' + b + '" class="' + o + '" method="post" key="set-mine" enctype="multipart/form-data" action="' + e.url + '">', "</form>"].join(""));
            y("#" + b)[0] || y("body").append(t),
            e.elem.next().hasClass(o) || (this.elemFile.wrap(n),
                e.elem.next("." + o).append((i = [],
            ...
            var i, n, a, o, l = this, r = l.config, u = l.elemFile[0], c = function() {
                ...
                l.elemFile.parent().submit(),
                    ...
                    w.timer = setInterval(function() {
                        ...
                        e && (clearInterval(w.timer),
                            t.html(""),
                            p(0, e))
                    }, 30)
            }, p = function(e, t) {
                if (l.elemFile.next("." + x).remove(),
                    u.value = "",
                ...
                layui.each(e || l.chooseFiles, function(e, t) {
                    n.push(t.name)
                }),
                n), g = {
                preview: function(e) {
                ...
                video: "\u89c6\u9891",
                audio: "\u97f3\u9891"
            }[r.accept] || "\u6587\u4ef6", h = 0 === h.length ? u.value.match(/[^\/\\]+\..+/g) || [] || "" : h;
            if (0 !== h.length) {
                switch (r.accept) {
                    case "file":
                        layui.each(h, function(e, t) {
                            if (m && !RegExp(".\\.(" + m + ")$", "i").test(escape(t)))
                                return i = !0
                        });
                        break;
                    case "video":
                        layui.each(h, function(e, t) {
                            if (!RegExp(".\\.(" + (m || "avi|mp4|wma|rmvb|rm|flash|3gp|flv") + ")$", "i").test(escape(t)))
                                return i = !0
                        });
                        break;
                    case "audio":
                        layui.each(h, function(e, t) {
                            if (!RegExp(".\\.(" + (m || "mp3|wav|mid") + ")$", "i").test(escape(t)))
                                return i = !0
                        });
                        break;
                    default:
                        layui.each(h, function(e, t) {
                            if (!RegExp(".\\.(" + (m || "jpg|png|gif|bmp|jpeg") + ")$", "i").test(escape(t)))
                                return i = !0
                        })
                }
                if (i)
                    return l.msg("\u9009\u62e9\u7684" + v + "\u4e2d\u5305\u542b\u4e0d\u652f\u6301\u7684\u683c\u5f0f"),
                        u.value = "";
                if ("choose" !== t && !r.auto || (r.choose && r.choose(g),
                "choose" !== t)) {
                    if (l.fileLength = (a = 0,
                        v = c(),
                        layui.each(v, function() {
                            a++
                        }),
                        a),
        ...
        w.prototype.events = function() {
            var n = this
                ...
                i.next().hasClass(x) && i.next().remove(),
                    n.upload(null, "choose"),
                n.isFile() || a.choose || i.after('<span class="layui-inline ' + x + '">' + e + "</span>")
            }
                , r = function() {
                var e = y(this);
            ...
            a.drag && a.elem.on("dragover", function(e) {
                e.preventDefault(),
                    y(this).trigger("upload.over")
            }).on("dragleave", function(e) {
                y(this).trigger("upload.leave")
            }).on("drop", function(e) {
                e.preventDefault(),
                    y(this).trigger("upload.drop", e)
            }),
...
layui.define(["lay", "layer", "util"], function(e) {
    ...
    var b = layui.$
        ...
        , i = (t.prototype.set = function(e) {
            return b.extend(!0, this.config, e),
                this
        }
            ,
            t.prototype.verify = function(e) {
                return b.extend(!0, this.config.verify, e),
                    this
            }
            ,
            ...
            t.prototype.render = function(e, t) {
                var i = this.config
                                ...
                                var l = b(this)
                                    ...
                                    "auto" === t.show && c(i, l.val()),
                                        ...
                                        e.on("click", function() {
                                            ...
                                            b(this).hasClass(q) || ("function" == typeof t.click && t.click.call(this, l, t),
                    ...
                    select: function(e) {
                        var p, c = "\u8bf7\u9009\u62e9", m = "layui-form-select", g = "layui-select-title", x = "layui-select-none", k = "", e = e || a.find("select"), C = function(e, t) {
                            b(e.target).parent().hasClass(g) && !t || (b("." + m).removeClass(m + "ed " + m + "up"),
                            p && k && p.val(k)),
                                p = null
                        }, u = function(a, e, t) {
                            var s, r, i, n, o, l, c = b(this), u = a.find("." + g), d = u.find("input"), f = a.find("dl"), h = f.children("dd"), y = f.children("dt"), v = this.selectedIndex;
                                        ...
                                        , r = (9 === e && n(),
                                            function(a, n) {
                                                ...
                                                var e = function() {
                                                    ...
                                                    , i = e[a]("dd:not(." + $ + ")");
                                                return t[0] ? (s = e[a](),
                                                    i[0] && !i.hasClass(q) || !s[0] ? (i.addClass(T).siblings().removeClass(T),
                                                        void o()) : r(a, s)) : s = null
                                            }
                                    );
                                    38 === e && r("prev"),
                            ...
                            t && d.on("input propertychange", function(e) {
                                ...
                                h.on("click", function() {
                                    var e = b(this)
                                        , t = e.attr("lay-value")
                                        , i = c.attr("lay-filter");
                                    return e.hasClass(q) || (e.hasClass("layui-select-tips") ? d.val("") : (d.val(e.text()),
                                        e.addClass(T)),
                        ...
                        e.each(function(e, t) {
                            ...
                            0 === s.length && s.push('<dd lay-value="" class="' + q + '">\u6ca1\u6709\u9009\u9879</dd>'),
                            s.join("") + "</dl>"), "</div>"].join(""));
                            a[0] && a.remove(),
                                i.after(r),
                                u.call(this, r, n, o)
                    ...
                    checkbox: function(e) {
                        ...
                        e.each(function(e, t) {
                            var i = b(this)
                                ...
                                , l = this.disabled
                                , r = (i.next("[lay-checkbox]")[0] && (n = i.next().html() || ""),
                                n = "switch" === a ? n.split("|") : [n],
                            o[a = c[a] ? a : "primary"] || o.checkbox);
                            if ("string" == typeof i.attr("lay-ignore"))
                                return i.show();
                            var s = i.next("." + r[0])
                    ...
                    radio: function(e) {
                        ...
                        e.each(function(e, t) {
                            ...
                            if ("string" == typeof i.attr("lay-ignore"))
                                return i.show();
                            a[0] && a.remove();
                            n = b(['<div class="layui-unselect ' + r, t.checked ? " " + r + "ed" : "", (n ? " layui-radio-disabled " + q : "") + '">', '<i class="layui-anim layui-icon ' + s[t.checked ? 0 : 1] + '"></i>', "<div>" + (a = d.escape(t.title || ""),
                                ...
                                function(a) {
                                    ...
                                    a.on("click", function() {
                                        ...
                                        n[0].disabled || (layui.each(e, function() {
                                            ...
                                            this.checked = !1,
                                                e.removeClass(r + "ed"),
                                                e.find(".layui-icon").removeClass(l + " " + s[0]).addClass(s[1])
                                        }),
                                            n[0].checked = !0,
                                            a.addClass(r + "ed"),
                                            a.find(".layui-icon").addClass(l + " " + s[0]),
                ...
                return "object" === layui.type(e) ? b(e).is(o) ? (a = b(e),
...
layui.define(["lay", "laytpl", "laypage", "form", "util"], function(e) {
    ...
    var p = layui.$
        ...
        var t = this.config || {}
            , a = (e = e || {}).item3
            , i = e.content
            , t = (("escape"in a ? a : t).escape && (i = g.escape(i)),
        ...
        , d = (n.prototype.config = {
            ...
            n.prototype.render = function(e) {
                ...
                a.index = t.index,
                    ...
                    a.height && /^full-\d+$/.test(a.height) ? (t.fullHeightGap = a.height.split("-")[1],
                        a.height = I.height() - t.fullHeightGap) : a.height && /^#\w+\S*-\d+$/.test(a.height) && (i = a.height.split("-"),
                        t.parentHeightGap = i.pop(),
                        t.parentDiv = i.join("-"),
                        a.height = p(t.parentDiv).height() - t.parentHeightGap);
                var l, e = a.elem, i = e.next("." + _), n = t.elem = p("<div></div>");
                n.addClass((l = [_, _ + "-" + t.index, "layui-form", "layui-border-box"],
                a.className && l.push(a.className),
                    ...
                    a.height && l.push("height:" + a.height + "px;"),
                        l.join(""))
                }).html(m(r, {
                    open: "{{",
                    close: "}}"
            ...
            n.prototype.setInit = function(e) {
                ...
                c.height = c.maxHeight || c.height,
                c.css && -1 === c.css.indexOf(_) && (a = c.css.split("}"),
            ...
            n.prototype.pullData = function(t, a) {
                ...
                "function" == typeof n.before && n.before(n),
                    ...
                    n.url ? (e = {},
                    n.page && (e[o.pageName] = t,
                        e[o.limitName] = n.limit),
                        o = p.extend(e, n.where),
                    n.contentType && 0 == n.contentType.indexOf("application/json") && (o = JSON.stringify(o)),
                        ...
                        p.ajax({
                            ...
                            success: function(e) {
                                (e = "function" == typeof n.parseData ? n.parseData(e) || e : e)[d.statusName] != d.statusCode ? l.errorView(e[d.msgName] || '\u8fd4\u56de\u7684\u6570\u636e\u4e0d\u7b26\u5408\u89c4\u8303\uff0c\u6b63\u786e\u7684\u6210\u529f\u72b6\u6001\u7801\u5e94\u4e3a\uff1a"' + d.statusName + '": ' + d.statusCode) : (l.renderData({
                                    ...
                                    l.setColsWidth(),
                                "function" == typeof n.done && n.done(e, t, e[d.countName])
                            },
                            error: function(e, t) {
                        ...
                        o = t * n.limit - n.limit,
                        i = n.data.concat(),
                        e[d.dataName] = n.page ? i.splice(o, n.limit) : i,
            ...
            n.prototype.getTrHtml = function(t, a, l, e) {
                ...
                return l = l || 1,
                    layui.each(t, function(o, d) {
                        ...
                        "array" === layui.type(d) && 0 === d.length || (d[x.config.numbersName] = s,
                        a || (d[x.config.indexName] = o),
                            u.eachCols(function(e, l) {
                                var t, e = l.field || e, a = l.key, n = d[e];
                                n !== undefined && null !== n || (n = ""),
                                l.colGroup || (t = ['<td data-field="' + e + '" data-key="' + a + '" ' + (e = [],
                                (t = "function" == typeof l.edit ? l.edit(d) : l.edit) && e.push('data-edit="' + t + '"'),
                                ...
                                l.style && e.push('style="' + l.style + '"'),
                                    ...
                                    var e, t = p.extend(!0, {
                                        LAY_COL: l
                                    }, d), a = x.config.checkName, i = x.config.disabledName;
                                    switch (l.type) {
                                        case "checkbox":
                                        ...
                                        case "radio":
                                            return t[a] && (u.thisCheckedRowIndex = o),
                                    ...
                                    i.push(t),
                                l.fixed && "right" !== l.fixed && c.push(t),
                                "right" === l.fixed && r.push(t))
                            }),
                            n.push('<tr data-index="' + o + '">' + i.join("") + "</tr>"),
                            h.push('<tr data-index="' + o + '">' + c.join("") + "</tr>"),
                            f.push('<tr data-index="' + o + '">' + r.join("") + "</tr>"))
                    }),
                    {
                        trs: n,
                        trs_fixed: h,
            ...
            n.prototype.renderData = function(e) {
                var a = this
                    ...
                    , s = []
                    , u = function() {
                    if (i.HAS_SET_COLS_PATCH || a.setColsPatch(),
                        i.HAS_SET_COLS_PATCH = !0,
                        a.thisCheckedRowIndex = "",
                    !o && a.sortKey)
                        return a.sort({
                    ...
                    "reset" === i.scrollPos && a.layBody.scrollLeft(0),
                        a.layMain.find("." + N).remove(),
                        a.layMain.find("tbody").html(c.join("")),
                        a.layFixLeft.find("tbody").html(r.join("")),
                        a.layFixRight.find("tbody").html(s.join("")),
                        a.renderForm(),
                    "number" == typeof a.thisCheckedRowIndex && a.setRowChecked({
                        type: "radio",
                ...
                return x.cache[a.key] = d,
                    ...
                    a.layPage[i.page || i.pagebar ? "removeClass" : "addClass"](L),
                    a.layPage.find(A)[!i.page || 0 == n || 0 === d.length && 1 == l ? "addClass" : "removeClass"](h),
                    0 === d.length ? a.errorView(i.text.none) : (a.layFixLeft.removeClass(L),
                        o ? u() : (u(),
                            a.renderTotal(d, t),
                        a.layTotal && a.layTotal.removeClass(L),
                ...
                r.totalRow && (layui.each(e, function(e, i) {
                    ...
                    c.eachCols(function(e, t) {
                        var a, e = t.field || e, i = o && o[t.field], l = "totalRowDecimals"in t ? t.totalRowDecimals : 2, l = s[e] ? parseFloat(s[e] || 0).toFixed(l) : "", l = (a = t.totalRowText || "",
                            ...
                            n = t.totalRow && w.call(c, {
                                item3: t,
                                content: l,
                                tplData: n
                            }) || a,
                        i || n), n = (t.field && c.dataTotal.push({
                            field: t.field,
                            ...
                            t.style && n.push('style="' + t.style + '"'),
                                n.join(" ")) + ">" + ("string" == typeof (a = t.totalRow || r.totalRow) ? m(a).render(p.extend({
                                TOTAL_NUMS: i || s[e],
                                TOTAL_ROW: o || {},
                                LAY_COL: t
                            }, t)) : l), "</div></td>"].join(""));
                    ...
                    e = c.layTotal.find(".layui-table-patch"),
                    c.layTotal.find("tbody").html("<tr>" + d.join("") + (e.length ? e.get(0).outerHTML : "") + "</tr>"))
            }
            ,
            ...
            n.prototype.setRowChecked = function(a, e) {
                ...
                "checkbox" !== (a = p.extend({
                    type: "checkbox",
                    checked: !0
                }, a)).type && "all" !== a.index && n.addClass(l).siblings("tr").removeClass(l),
                a.selectedStyle || e || (l = x.cache[t.key],
                    ...
                    }[a.type] || "checkbox") + '"]').prop("checked", a.checked),
                    t.syncCheckAll(),
                    t.renderForm(a.type))
            }
            ,
            ...
            n.prototype.fullSize = function() {
                ...
                i.fullHeightGap ? (l = I.height() - i.fullHeightGap,
                    i.elem.css("height", l = l < 135 ? 135 : l)) : i.parentDiv && i.parentHeightGap && (l = p(i.parentDiv).height() - i.parentHeightGap,
                ...
                l && (e = parseFloat(l) - (i.layHeader.outerHeight() || 39) - 1,
                t.toolbar && (e -= i.layTool.outerHeight() || 50),
                t.totalRow && (e -= (i.layTotal.outerHeight() || 40) - 1),
                (t.page || t.pagebar) && (e -= (i.layPage.outerHeight() || 43) - 1),
            ...
            n.prototype.scrollPatch = function() {
                ...
                e.layFixed.find(R).css("height", t.height() >= n ? n : "auto"),
                    e.layFixRight[x.cache[e.key] && x.cache[e.key].length && 0 < l ? "removeClass" : "addClass"](L),
                ...
                var s = this
                                    ...
                                    list: (a = [],
                                        ...
                                        v.on("checkbox(LAY_TABLE_TOOL_COLS)", function(e) {
                                            var e = p(e.elem)
                                                ...
                                                , e = e.data("parentkey");
                                            i.key && (i.hide = !t,
                                                s.elem.find('*[data-key="' + a + '"]')[t ? "removeClass" : "addClass"](L),
                                            l != i.hide && s.setParentCol(!t, e),
                                                s.resize(),
                                                layui.event.call(this, T, "colToggled(" + c + ")", {
                                                    col: i,
                                                    config: u
                                                }))
                                        })
                    ...
                    k.docEvent || F.on("mousemove", function(e) {
                        ...
                        t.rule && (e = t.ruleWidth + e.clientX - t.offset[0],
                            a = k.eventMoveElem.closest("." + _).attr("lay-id"),
                        ...
                        var t, a, i, l, n;
                        k.eventMoveElem && (i = (t = k.eventMoveElem).closest("." + _).attr("lay-id"),
                        (a = C(i)) && (i = t.data("key"),
                            l = a.col(i),
                                            ...
                                            r[i] = a.data[i] = l,
                                                s.eachCols(function(e, t) {
                                                    ...
                                                    t.field == i ? (o.html(w.call(s, {
                                                        ...
                                                        n.data("content", l)) : d && (t.templet || t.toolbar) && (e = c.children('td[data-field="' + (t.field || e) + '"]'),
                                                        a = r[t.field],
                    ...
                    , t = (s.elem.on("click", 'input[name="layTableCheckbox"]+', function() {
                        var e = p(this)
                            , t = e.closest("td")
                            , e = e.prev()
                            , a = s.layBody.find('input[name="layTableCheckbox"]')
                            , i = e.parents("tr").eq(0).data("index")
                            , l = e[0].checked
                            , n = "layTableAllChoose" === e.attr("lay-filter");
                        e[0].disabled || (n ? (a.each(function(e, t) {
                            t.checked = l,
                                s.setCheckData(e, l)
                        }),
                            s.syncCheckAll(),
                            s.renderForm("checkbox")) : (s.setCheckData(i, l),
                            s.syncCheckAll()),
                            layui.event.call(e[0], T, "checkbox(" + c + ")", r.call(e[0], {
                                checked: l,
                                type: n ? "all" : "one",
                                getCol: function() {
                    ...
                    (e = p(e)).data("off") || (a = e.data("field"),
                        ...
                        i = x.cache[s.key][i],
                        l = e.children(y),
                    (n = "function" == typeof n.edit ? n.edit(i) : n.edit) && ((n = p("textarea" === n ? '<textarea class="layui-input ' + E + '"></textarea>' : '<input class="layui-input ' + E + '">'))[0].value = e.data("content") || i[a] || l.text(),
                    ...
                    e[i] = a,
                        l.update(e),
                        layui.event.call(t[0], T, "edit(" + c + ")", l)
                }).on("blur", "." + E, function() {
                    p(this).remove()
                }),
            ...
            x.init = function(i, o) {
                ...
                return e.each(function() {
                    var l, e = p(this), t = e.attr("lay-data"), t = c.options(this, {
    ...
    x.eachCols = function(e, a, i) {
        ...
        x.exportFile = function(e, t, a) {
            ...
            var o, d, i, c, l = (a = "object" == typeof a ? a : (l = {},
            a && (l.type = a),
                l)).type || "csv", r = k.that[e], n = k.config[e] || {}, s = {
                csv: "text/csv",
            ...
            u.href = "data:" + s + ";charset=utf-8,\ufeff" + encodeURIComponent((o = [],
                ...
                layui.each(t, function(i, l) {
                    ...
                    "object" == typeof e ? (layui.each(e, function(e, t) {
                        ...
                        var a;
                        t.field && "normal" == t.type && (t.hide || t.ignoreExport ? 0 == i && (c[t.field] = !0) : ((a = l[t.field]) !== undefined && null !== a || (a = ""),
        ...
        x.hideCol = function(e, l) {
            ...
            n && ("boolean" === layui.type(l) ? n.eachCols(function(e, t) {
                var a = t.key
                    ...
                    , t = t.parentKey;
                i.hide != l && (i = i.hide = l,
                    n.elem.find('*[data-key="' + a + '"]')[i ? "addClass" : "removeClass"](L),
                    n.setParentCol(i, t))
...
layui.define(["table"], function(e) {
    ...
    var E = layui.$
        ...
        , L = function(e) {
        var t = i.that[e];
        return t || u.error(e ? "The treeTable instance with ID '" + e + "' not found" : "ID argument required"),
        t || null
    }
        , B = "layui-hide"
        , F = ".layui-table-main"
        ...
        var t = this;
        t.index = ++P.index,
            t.config = E.extend(!0, {}, t.config, P.config, e),
            t.init(),
            t.render()
    }
        , c = function(n, i, e) {
        ...
        , l = function(i, a, e) {
        var l = L(i)
            , t = E.extend(!0, {}, l.getOptions(), a)
            , n = t.tree
            , d = n.customName.children
            , r = (delete a.hasNumberCol,
        ...
        t.url ? e && (!r || r.mod) || (a.parseData = function() {
            var e = this
                , t = arguments
                , a = t[0]
                , t = ("function" === layui.type(r) && (a = r.apply(e, t) || t[0]),
                e.response.dataName);
        ...
        a.initSort && a.initSort.type && layui.sort(a.data, a.initSort.field, "desc" === a.initSort.type, !0),
            l.initData(a.data)),
        e && (!o || o.mod) || (a.done = function() {
            var e, t = arguments, a = this.elem.next(), n = (l.updateStatus(null, {
                LAY_HAS_EXPANDED: !1
            }),
                c(i, d),
    ...
    var n, z = function(e, t, a) {
        ...
        var m = y[X]
            ...
            , v = (g.html(h ? u.view.flexIconOpen : u.view.flexIconClose),
        y[s] && g.css("visibility", "visible"),
        u.view.showIcon && b.find(".layui-table-tree-nodeIcon:not(.layui-table-tree-iconCustom,.layui-table-tree-iconLeaf)").html(h ? u.view.iconOpen : u.view.iconClose),
        y[f.children] || []);
        if (h)
            if (m)
                ...
                if (b.enable && y[s] && A && !y[V])
                    return y[V] = "loading",
                        N = E.extend({}, b.where || o.where),
                        I = b.autoParam,
                        layui.each(I, function(e, t) {
                            t = t.split("=");
                            N[t[0].trim()] = y[(t[1] || t[0]).trim()]
                        }),
                    (I = b.contentType || o.contentType) && 0 == I.indexOf("application/json") && (N = JSON.stringify(N)),
                        S = b.method || o.method,
                        C = b.dataType || o.dataType,
                        _ = b.jsonpCallback || o.jsonpCallback,
                        D = b.headers || o.headers,
                        T = b.parseData || o.parseData,
                        k = b.response || o.response,
                        ...
                        E.ajax({
                            ...
                            success: function(e) {
                                y[V] = "success",
                                    (e = "function" == typeof T ? T.call(o, e) || e : e)[k.statusName] != k.statusCode ? (y[V] = "error",
                                        g.html('<i class="layui-icon layui-icon-refresh"></i>')) : (y[f.children] = e[k.dataName],
                                        c.initData(y[f.children], y[H]),
                                        U(t, !0, !p && n, i, l))
                            },
                            error: function(e, t) {
                                y[V] = "error",
                ...
                v.length && (!o.initSort || o.url && !o.autoSort || ((b = o.initSort).type ? layui.sort(v, b.field, "desc" === b.type, !0) : layui.sort(v, j.config.indexName, null, !0)),
                    ...
                    layui.each(v, function(e, t) {
                        O.trs.eq(e).attr({
                            ...
                            O.trs_fixed_r.eq(e).attr({
                                "data-index": t[H],
                                "lay-data-index": t[H],
                                "data-level": w
                            })
                    }),
                    d.find(F).find('tbody tr[lay-data-index="' + e + '"]').after(O.trs),
                    d.find(q).find('tbody tr[lay-data-index="' + e + '"]').after(O.trs_fixed),
                    d.find(Y).find('tbody tr[lay-data-index="' + e + '"]').after(O.trs_fixed_r),
            ...
            y[R] = h,
                n && !p ? (layui.each(v, function(e, t) {
                    ...
                    d.find(v.map(function(e, t, a) {
                        return 'tr[lay-data-index="' + e[H] + '"]'
                    }).join(",")).addClass(B)) : (A = c.treeToFlat(v, y[f.id], e),
                    d.find(A.map(function(e, t, a) {
                        return 'tr[lay-data-index="' + e[H] + '"]'
                    }).join(",")).addClass(B));
        return z(r, function() {
            P.resize(r)
        }, 25)(),
        l && "loading" !== y[V] && (I = u.callback.onExpand,
        "function" === layui.type(I) && I(r, y, a)),
            x
            ...
            P.expandAll = function(a, e) {
                if ("boolean" !== layui.type(e))
                    return u.error("expandAll \u7684\u5c55\u5f00\u72b6\u6001\u53c2\u6570\u53ea\u63a5\u6536true/false");
                var t = L(a);
                if (t) {
                    var n = t.getOptions()
                        , i = n.tree
                    ...
                    if (e) {
                        ...
                        layui.each(n, function(e, t) {
                            ...
                            c ? (t.updateStatus(null, function(e) {
                                ...
                                l.find('tbody tr[data-level!="0"]').removeClass(B),
                                l.find(".layui-table-tree-flexIcon").html(i.view.flexIconOpen),
                            i.view.showIcon && l.find(".layui-table-tree-nodeIcon:not(.layui-table-tree-iconCustom,.layui-table-tree-iconLeaf)").html(i.view.iconOpen)) : (t.updateStatus(null, function(e) {
                                e[d] && (e[R] = !0,
                                    e[X] = !0)
                            }),
                                e = j.getTrHtml(a, n),
                        ...
                        t.updateStatus(null, function(e) {
                            ...
                            l.find('.layui-table-box tbody tr[data-level!="0"]').addClass(B),
            ...
            t.prototype.renderTreeTable = function(e, t, a) {
                ...
                d.view || {})
                    ...
                    , c = i.attr("lay-filter")
                    , u = this
                    , f = ((t = t || 0) || (i.find(".layui-table-body tr:not([data-level])").attr("data-level", t),
                    layui.each(j.cache[l], function(e, t) {
                        i.find('.layui-table-main tbody tr[data-level="0"]:eq(' + e + ")").attr("lay-data-index", t[H]),
                            i.find('.layui-table-fixed-l tbody tr[data-level="0"]:eq(' + e + ")").attr("lay-data-index", t[H]),
                            i.find('.layui-table-fixed-r tbody tr[data-level="0"]:eq(' + e + ")").attr("lay-data-index", t[H])
                    })),
                    {})
                    , t = d.name
                    , s = r.indent || 14;
                layui.each(e.find('td[data-field="' + t + '"]'), function(e, t) {
                    ...
                    i.hasClass("layui-table-tree-item") || (i.addClass("layui-table-tree-item"),
                    (i = n.attr("lay-data-index")) && ((a = u.getNodeDataByIndex(i))[R] && (f[i] = !0),
                        i = t.find("div.layui-table-cell").html(),
                ...
                !1 !== a && layui.each(f, function(e, t) {
                    ...
                    e.find(".layui-table-tree-flexIcon").html(r.flexIconOpen),
                        U({
                            trElem: e.first()
                        }, !0)
                }),
                n.hasNumberCol && this.formatNumber(l),
                    y.render(null, c)
            }
            ,
                ...
                clearTimeout(e),
                    a[e] = setTimeout(function() {
                        ...
                        e = (n = t).getOptions(),
                            i = e.elem.next(),
                            l = 0,
                            layui.each(n.treeToFlat(j.cache[e.id]), function(e, t) {
                                var a;
                                layui.isArray(t) || ((a = n.getNodeDataByIndex(t[H])).LAY_NUM = ++l,
                                    i.find('tr[lay-data-index="' + t[H] + '"] .laytable-cell-numbers').html(a.LAY_NUM))
                            })
                    }, 10)
            }
            ,
            t.prototype.render = function(e) {
                var t = this;
                t.tableIns = j["reloadData" === e ? "reloadData" : "reload"](t.tableIns.config.id, E.extend(!0, {}, t.config)),
            ...
            P.sort = function(e) {
                var t, a, n, i, l = L(e);
                l && (a = (t = l.getOptions()).initSort,
                    t.url ? t.autoSort && (n = l.initData(),
                        (i = {})[t.response.dataName] = n,
                    "function" == typeof t.done && t.done(i, l.page, l.count)) : (a.type ? layui.sort(t.data, a.field, "desc" === a.type, !0) : layui.sort(t.data, j.config.indexName, null, !0),
                        l.initData(t.data),
                        P.reloadData(e)))
            }
            ,
            ...
            P.removeNode = function(e, t) {
                ...
                r && (d = (a = r.getOptions()).tree,
                    n = a.elem.next(),
                    i = [],
                    t = r.getNodeDataByIndex("string" === layui.type(t) ? t : t[H], !1, "delete"),
                    l = r.getNodeDataByIndex(t[f]),
                    r.updateCheckStatus(l, !0),
                    l = r.treeToFlat([t], t[d.customName.pid], t[f]),
                    layui.each(l, function(e, t) {
                    ...
                    layui.each(r.treeToFlat(d), function(e, t) {
                        t[h] && t[h] !== t[H] && n.find('tr[lay-data-index="' + t[h] + '"]').attr({
                            "data-index": t[H],
                            "lay-data-index": t[H]
                        })
                    }),
            ...
            P.addNodes = function(e, t) {
                ...
                if (y)
                    return u = y.getOptions(),
                        ...
                        l = t.data,
                        t = t.focus,
                        n = (s = "number" === layui.type(s) ? s.toString() : s) ? y.getNodeDataByIndex(s) : null,
                        i = "number" === layui.type(i) ? i : -1,
                        l = E.extend(!0, [], layui.isArray(l) ? l : [l]),
                        y.getTableData(),
                        n ? (d = f.customName.isParent,
                            f = f.customName.children,
                            n[d] = !0,
                            c = (c = n[f]) ? (r = c.splice(-1 === i ? c.length : i),
                                n[f] = c.concat(l, r)) : n[f] = l,
                            y.updateStatus(c, function(e) {
                                e[d] && (e[X] = !1)
                            }),
                            f = y.treeToFlat(c),
                            a.find(f.map(function(e) {
                                return 'tr[lay-data-index="' + e[H] + '"]'
                            }).join(",")).remove(),
                            y.initData(),
                            n[X] = !1,
                            n[V] = "local",
                            U({
                                trElem: a.find('tr[lay-data-index="' + s + '"]')
                            }, !0)) : (r = j.cache[e].splice(-1 === i ? j.cache[e].length : i),
                            j.cache[e] = j.cache[e].concat(l, r),
                        u.url || (u.page ? (c = u.page,
                            u.data.splice.apply(u.data, [c.limit * (c.curr - 1), c.limit].concat(j.cache[e]))) : u.data = j.cache[e]),
                            y.initData(),
                            f = j.getTrHtml(e, l),
                            o = {
                                trs: E(f.trs.join("")),
                            ...
                            u = a.find(q),
                            f = a.find(Y),
                            -1 == s ? (c.find('tr[data-level="0"][data-index="0"]').before(o.trs),
                                u.find('tr[data-level="0"][data-index="0"]').before(o.trs_fixed),
                                f.find('tr[data-level="0"][data-index="0"]').before(o.trs_fixed_r)) : -1 === i ? (c.find("tbody").append(o.trs),
                                u.find("tbody").append(o.trs_fixed),
                                f.find("tbody").append(o.trs_fixed_r)) : (s = r[0][h],
                                c.find('tr[data-level="0"][data-index="' + s + '"]').before(o.trs),
                                u.find('tr[data-level="0"][data-index="' + s + '"]').before(o.trs_fixed),
                                f.find('tr[data-level="0"][data-index="' + s + '"]').before(o.trs_fixed_r)),
                            layui.each(j.cache[e], function(e, t) {
                        ...
                        y.updateCheckStatus(n, !0),
                        P.resize(e),
                    t && a.find(F).find('tr[lay-data-index="' + l[0][H] + '"]').get(0).scrollIntoViewIfNeeded(),
                        l
            }
            ,
            P.checkStatus = function(e) {
                var t, a;
                if (L(e))
                    return t = P.getData(e, !0).filter(function(e, t, a) {
                        return e[j.config.checkName]
                    }),
                        a = !0,
                        layui.each(j.cache[e], function(e, t) {
                            if (!t[j.config.checkName])
                                return !(a = !1)
                        }),
                        {
                            data: t,
            ...
            t.prototype.updateCheckStatus = function(e, t) {
                var a = this.getOptions()
                    ...
                    , d = (e && (a = this.updateParentCheckStatus(e, t),
                    layui.each(a, function(e, t) {
                ...
                return layui.each(j.cache[n], function(e, t) {
                    ...
                    r = r && !d,
                    y.render(i.find('input[name="layTableCheckbox"][lay-filter="layTableAllChoose"]').prop({
                        checked: d,
                        indeterminate: r
                    })),
                    d
            ...
            t.prototype.updateParentCheckStatus = function(a, n) {
                var e = this.getOptions()
                    ...
                    , l = [];
                return a[s] = !1,
                    n ? a[t].length ? layui.each(a[t], function(e, t) {
                        if (!t[i])
                            return n = !1,
                                a[s] = !0
                    ...
                    a[i] = n,
                    l.push(E.extend({}, a)),
                    l = a[f] ? l.concat(this.updateParentCheckStatus(j.cache[e][a[f]], n)) : l
            }
            ,
            function(e, t, a) {
                var n = this
                ...
                if (a) {
                    ...
                    a && (n.updateStatus(null, function(e) {
                        e[u] && (e[u] = !1,
                            y.render(d.find('tr[lay-data-index="' + e[H] + '"] input[type="radio"][lay-type="layTableRadio"]').prop("checked", !1)))
                    }),
                        a[u] = t,
                        y.render(e.find('input[type="radio"][lay-type="layTableRadio"]').prop("checked", t)))
                }
            }
    );
    P.on("checkbox", function(e) {
        ...
        P.setRowChecked = function(e, t) {
            var a, n, i, l, d, r = L(e);
            r && (a = r.getOptions().elem.next(),
                i = (t = t || {}).index,
                n = t.checked,
                t = t.callbackFlag,
                i = "string" === layui.type(i) ? i : i[H],
            (l = r.getNodeDataByIndex(i)) && ((d = a.find('tr[lay-data-index="' + i + '"]')).length || (P.expandNode(e, {
                index: l[f],
                expandFlag: !0
            }),
                d = a.find('tr[lay-data-index="' + i + '"]')),
                o.call(r, d, n, t)))
        }
        ,
...
layui.define(["lay", "util", "element", "form"], function(e) {
    ...
    e("code", function(e) {
        ...
        e.elem[0] && layui.each(e.elem.get().reverse(), function(e, a) {
            var t, l, i, o, n, s, c, d, r, u, y = _(a), E = _.extend(!0, {}, M, lay.options(a), (t = {},
                layui.each(["title", "height", "encode", "skin", "about"], function(e, a) {
                    var i = y.attr("lay-" + a);
                    "string" == typeof i && (t[a] = i)
                }),
                t)), p = y.data("code") || (i = [],
                y.children("textarea").each(function() {
                    i.push(I(this.value))
                }),
            0 === i.length && i.push(I(y.html())),
                i), f = (y.data("code", p),
                {
                    copy: {
                        className: "file-b",
                ...
                }), v = (E.preview && (a = "LAY-CODE-DF-" + e,
                r = E.layout || ["code", "preview"],
                o = "iframe" === E.preview,
                L = _('<div class="' + T.ELEM_PREVIEW + '">'),
                d = _('<div class="layui-tab layui-tab-brief">'),
                n = _('<div class="layui-tab-title">'),
                u = _('<div class="' + [T.ELEM_ITEM, T.ELEM_ITEM + "-preview", "layui-border"].join(" ") + '">'),
                s = _('<div class="layui-code-tools"></div>'),
                m = y.parent("." + T.ELEM_PREVIEW),
                v = y.prev("." + T.ELEM_TAB),
                h = y.next("." + T.ELEM_ITEM + "-preview"),
            E.id && L.attr("id", E.id),
                L.addClass(E.className),
                d.attr("lay-filter", a),
                E.encode = !0,
                layui.each(r, function(e, a) {
                    var i = _('<li lay-id="' + a + '">');
                ...
                _.extend(f, {
                    full: {
                        ...
                        event: function(e, a) {
                            ...
                            e.hasClass(t) ? (i.addClass(T.ELEM_FULL),
                                e.removeClass(t).addClass(l),
                                e.attr("title", o[1]),
                                n.addClass(s)) : (i.removeClass(T.ELEM_FULL),
            ...
            E.copy && "array" === layui.type(E.tools) && E.tools.unshift("copy"),
                s.on("click", ">i", function() {
                    var e = _(this)
                        , a = e.data("type");
                    "function" == typeof f[a].event && f[a].event(e, a),
                    "function" == typeof E.toolsEvent && E.toolsEvent(e, a)
                }),
            ...
            m[0] && y.unwrap(),
                d.append(n),
            E.tools && d.append(s),
                y.wrap(L).addClass(T.ELEM_ITEM).before(d),
            o && u.html("<iframe></iframe>"),
                c = function(e) {
                ...
                ,
                "preview" === r[0] ? (u.addClass(T.ELEM_SHOW),
                    y.before(u),
                    c(u)) : y.addClass(T.ELEM_SHOW).after(u),
                E.codeStyle = [E.style, E.codeStyle].join(""),
                E.previewStyle = [E.style, E.previewStyle].join(""),
                u.attr("style", E.previewStyle),
                w.on("tab(" + a + ")", function(e) {
                    var a = _(this)
                        , i = _(e.elem).closest("." + T.ELEM_PREVIEW).find("." + T.ELEM_ITEM)
                        , e = i.eq(e.index);
                    i.removeClass(T.ELEM_SHOW),
                        e.addClass(T.ELEM_SHOW),
                    "preview" === a.attr("lay-id") && c(e)
                })),
                E.ln ? "ol" : "ul"), h = _("<" + v + ' class="layui-code-' + v + '">'), m = _('<div class="' + T.ELEM_TITLE + '">'), L = (y.addClass("layui-code-view layui-box"),
            E.skin && ("notepad" === E.skin && (E.skin = "dark"),
                y.removeClass("layui-code-dark layui-code-light"),
                y.addClass("layui-code-" + E.skin)),
                l = p.join(""));
            "function" == typeof E.codeParse && (L = l = E.codeParse(L)),
                L = (L = E.encode ? C.escape(L) : L).replace(/[\r\t\n]+/g, "</li><li>"),
                y.html(h.html("<li>" + L + "</li>")),
            E.header && !y.children("." + T.ELEM_TITLE)[0] && (m.html((E.title || E.text.code) + (E.about ? '<div class="layui-code-about">' + E.about + "</div>" : "")),
                y.prepend(m)),
            E.elem.length === e + 1 && "function" == typeof E.allDone && E.allDone(),
            0 < (d = Math.floor(h.find("li").length / 100)) && h.css("margin-left", d + "px"),
            E.height && h.css("max-height", E.height),
                h.attr("style", E.codeStyle),
            E.copy && !E.preview && (r = _(['<span class="' + T.ELEM_COPY + '">', '<i class="layui-icon layui-icon-file-b" title="\u590d\u5236"></i>', "</span>"].join("")),
                u = y.children("." + T.ELEM_COPY),
            (h[0].style.height || h[0].style.maxHeight) && r.addClass(T.ELEM_COPY + "-offset"),
            u[0] && u.remove(),
                y.append(r),
                r.on("click", function() {
                    f.copy.event()
